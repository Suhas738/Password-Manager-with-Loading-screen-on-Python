...
class Ui_LoadingScreen(object):
    ...
    def retranslateUi(self, LoadingScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("LoadingScreen", u"<strong>PASSWORD MANAGER</strong>", None))
        self.label_description.setText(QCoreApplication.translate("LoadingScreen", u"<strong>APP</strong> DESCRIPTION", None))
